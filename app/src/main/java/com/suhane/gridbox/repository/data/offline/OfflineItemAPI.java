package com.suhane.gridbox.repository.data.offline;
 ...
 */
public class OfflineItemAPI implements ItemAPI {
    @Inject
    Retrofit retrofit;

    public OfflineItemAPI() {
        GridBoxApp.getApp().offlineComponent().inject(this);
    }
